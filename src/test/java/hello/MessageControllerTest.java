...
import hello.controller.MessageController;
...
public class MessageControllerTest {
    ...
    {
        mockMvc.perform(get("/main")).andDo(print())
    ...
    {
        this.mockMvc.perform(get("/main").param("filter", "my-tag_1")).andDo(print())
                .andExpect(authenticated())
    ...
    public void addMessageToListTest() throws Exception
    {
        ...
        this.mockMvc.perform(multipart).andDo(print())
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#my-tag_5"));
    }
}
